...
#define TPM_IP_CPU_TO_TPM_SLV_REG0_OFFSET 0
#define TPM_IP_CPU_TO_TPM_SLV_REG1_OFFSET 4
#define TPM_IP_CPU_TO_TPM_SLV_REG2_OFFSET 8
#define TPM_IP_CPU_TO_TPM_SLV_REG3_OFFSET 12
