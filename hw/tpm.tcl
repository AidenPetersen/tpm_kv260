...
#
# tpm.tcl: Tcl script for re-creating project 'tpm_hw'
#
# Generated by Vivado on Tue Mar 25 23:40:06 CDT 2025
...
#
# 1. This project restoration tcl script (tpm.tcl) that was generated.
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set paths [list \
 "[file normalize "$origin_dir/[file normalize "$origin_dir/ip_repo/tpm_ip_1_0"]"]"\
 "[file normalize "$origin_dir/[file normalize "$origin_dir/ip_repo/tpm_ip_1_0"]"]"\
  ]
  foreach ipath $paths {
...
set orig_proj_dir "[file normalize "$origin_dir/tpm_hw"]"
...
set_property -name "platform.board_id" -value "k26c_som240_1_connector_kv260_carrier_som240_1_connector" -objects $obj
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "$origin_dir/ip_repo/tpm_ip_1_0"] [file normalize "$origin_dir/ip_repo/tpm_ip_1_0"]" $obj
...
set_property -name "top" -value "tpm_design_wrapper" -objects $obj
...
# Proc to create BD tpm_design
proc cr_bd_tpm_design { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name tpm_design
...
\
  ...
  connect_bd_intf_net -intf_net axi_smc_M01_AXI [get_bd_intf_pins axi_smc/M01_AXI] [get_bd_intf_pins tpm_ip_0/CPU_TO_TPM]
  connect_bd_intf_net -intf_net tpm_ip_0_TPM_TO_MAIN [get_bd_intf_pins tpm_ip_0/TPM_TO_MAIN] [get_bd_intf_pins axi_smc/S01_AXI]
  connect_bd_intf_net -intf_net tpm_ip_0_TPM_TO_PRIV [get_bd_intf_pins tpm_ip_0/TPM_TO_PRIV] [get_bd_intf_pins axi_bram_ctrl_1/S_AXI]
  ...
  [get_bd_pins tpm_ip_0/tpm_to_priv_aresetn] \
  [get_bd_pins tpm_ip_0/cpu_to_tpm_aresetn] \
  [get_bd_pins tpm_ip_0/tpm_to_main_aresetn]
  ...
  [get_bd_pins tpm_ip_0/tpm_to_priv_aclk] \
  [get_bd_pins tpm_ip_0/cpu_to_tpm_aclk] \
  [get_bd_pins tpm_ip_0/tpm_to_main_aclk]
  ...
  assign_bd_address -offset 0xA0010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs tpm_ip_0/CPU_TO_TPM/CPU_TO_TPM_reg] -force
  assign_bd_address -offset 0xA0000000 -range 0x00002000 -target_address_space [get_bd_addr_spaces tpm_ip_0/TPM_TO_MAIN] [get_bd_addr_segs axi_bram_ctrl_0/S_AXI/Mem0] -force
  assign_bd_address -offset 0xA0010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces tpm_ip_0/TPM_TO_MAIN] [get_bd_addr_segs tpm_ip_0/CPU_TO_TPM/CPU_TO_TPM_reg] -force
  assign_bd_address -offset 0xA0000000 -range 0x00002000 -target_address_space [get_bd_addr_spaces tpm_ip_0/TPM_TO_PRIV] [get_bd_addr_segs axi_bram_ctrl_1/S_AXI/Mem0] -force

  # Perform GUI Layout
  regenerate_bd_layout -layout_string {
   "ActiveEmotionalView":"Default View",
   "Default View_ScaleFactor":"1.0",
   "Default View_TopLeft":"268,-632",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.8.0 2024-04-26 e1825d835c VDI=44 GEI=38 GUI=JA:21.0 TLS
#  -string -flagsOSRD
preplace inst zynq_ultra_ps_e_0 -pg 1 -lvl 1 -x 700 -y -270 -defaultsOSRD
preplace inst axi_bram_ctrl_0 -pg 1 -lvl 2 -x 1240 -y -500 -defaultsOSRD
preplace inst axi_smc -pg 1 -lvl 3 -x 1590 -y -300 -defaultsOSRD
preplace inst rst_ps8_0_99M -pg 1 -lvl 2 -x 1240 -y 10 -defaultsOSRD
preplace inst axi_bram_ctrl_0_bram -pg 1 -lvl 6 -x 2660 -y -490 -defaultsOSRD
preplace inst tpm_ip_0 -pg 1 -lvl 4 -x 1960 -y -280 -defaultsOSRD
preplace inst axi_bram_ctrl_1 -pg 1 -lvl 5 -x 2330 -y -290 -defaultsOSRD
preplace netloc rst_ps8_0_99M_peripheral_aresetn 1 1 4 1050J -290 1420 -150 1760 -130 2180
preplace netloc zynq_ultra_ps_e_0_pl_clk0 1 0 5 390 -360 1040 -310 1440 -390 1740 -120 2170
preplace netloc zynq_ultra_ps_e_0_pl_resetn0 1 1 1 1010 -280n
preplace netloc axi_bram_ctrl_0_BRAM_PORTA 1 2 4 N -500 N -500 N -500 N
preplace netloc axi_smc_M00_AXI 1 1 3 1060J -420 NJ -420 1730
preplace netloc zynq_ultra_ps_e_0_M_AXI_HPM0_FPD 1 1 2 NJ -300 1420
preplace netloc tpm_ip_0_TPM_TO_PRIV 1 4 1 N -310
preplace netloc axi_bram_ctrl_1_BRAM_PORTA 1 5 1 2470 -480n
preplace netloc axi_smc_M01_AXI 1 3 1 1750 -360n
preplace netloc tpm_ip_0_TPM_TO_MAIN 1 2 3 1450 -140 NJ -140 2160
levelinfo -pg 1 -10 700 1240 1590 1960 2330 2660 2790
pagesize -pg 1 -db -bbox -sgen -10 -980 2790 180
"
}
...
# End of cr_bd_tpm_design()

cr_bd_tpm_design ""
set_property REGISTERED_WITH_MANAGER "1" [get_files tpm_design.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files tpm_design.bd ] 

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse [list tpm_design.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/tpm_hw/tpm_hw.gen/sources_1/bd/tpm_design/hdl/tpm_design_wrapper.v" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse [list tpm_design.bd]] -top]
